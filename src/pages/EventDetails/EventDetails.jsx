...
const EventDetails = () => {
    ...
    const {_id, thumbnail, event_type, title, description, event_details, event_date, location, organizer_photo, organizer_name, organizer_email} = event;
            ...
            <div className='py-[50px] md:py-[70px]'>
                <div className='container'>
                    <div className='max-w-[890px] mx-auto'>
                        <Link to='/upcoming-events' className='flex items-center gap-1.5 text-[16px] font-medium text-[#65758B] dark:text-white'><FaArrowLeft /><span>Back to Events</span></Link>
                        ...
                        <p className='inline-flex items-center gap-1.5 py-1.5 px-4 bg-[#E7F8F2] text-[15px] text-[#10B77F] font-medium rounded-full mt-5'><CiShoppingTag /><span>{event_type}</span></p>
                        ...
                        <div className='grid grid-cols-12 gap-5 items-start'>
                            ...
                            <div className='col-span-12 lg:col-span-5'>
                                ...
                                <div className='p-3 sm:p-5 border border-[#E1E7EF] dark:border-white rounded-2xl mt-4'>
                                    ...
                                    <button className='py-1.5 w-full bg-[#219E64] rounded mt-4 mb-3 text-white text-[17px] font-medium text-center'>Join Event</button>
