        ...
        <>
            <div className='py-[60px] lg:py-[90px]'>
                <div className='container'>
                    <h2 className='text-center text-[30px] sm:text-[38px] md:text-[45px] lg:text-[52px] font-bold text-[#141414]'>Community in Action</h2>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-[30px] md:mt-[50px]'>
                        {events.map((event, index) => (
                            <div key={index} className='relative rounded-xl overflow-hidden group cursor-pointer shadow-sm hover:shadow-md transition' >
