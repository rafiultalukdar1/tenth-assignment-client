        ...
        <>
            <div className='py-[60px] lg:py-[90px] bg-[#FDFDFD]'>
                <div className='container'>
                    <h2 className='text-center text-[30px] sm:text-[38px] md:text-[45px] lg:text-[52px] font-bold text-[#141414]'>Why Choose Social Impact?</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mt-[30px] md:mt-[50px]">
                        {
                            features.map((feature, index) => ( <div key={index} className="bg-white shadow-sm border border-gray-200 rounded-2xl p-8 text-center hover:shadow-lg transition">
                                <div className="flex justify-center items-center mb-4">
                                    <div className="bg-[#E9F7EF] w-14 h-14 rounded-full flex items-center justify-center"> {feature.icon} </div>
                                </div>
                                <h3 className="text-[18px] font-semibold text-[#141414] mb-1.5">{feature.title}</h3>
